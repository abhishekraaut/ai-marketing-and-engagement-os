    ...
    <div className="max-w-5xl mx-auto p-6 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="page-description">Configure your brand identity and AI guardrails.</p>
        </div>
        {!isEditing && (
          <button
            onClick={handleEdit}
            className="flex items-center gap-2 px-5 py-2.5 bg-primary text-white text-sm font-semibold rounded-lg shadow-md shadow-indigo-200 hover:bg-primary-hover hover:shadow-lg transition-all"
          >
      ...
      {isLoading ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-border space-y-6 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 border-b border-border pb-4">
                <div className="p-2 bg-indigo-50 rounded-lg"><Briefcase className="w-5 h-5 text-indigo-600" /></div>
                <h2 className="text-lg font-bold text-foreground">Core Identity</h2>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-border space-y-6 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 border-b border-border pb-4">
                ...
                <h2 className="text-lg font-bold text-foreground">Audience & Tone</h2>
              </div>
              <div className="space-y-5">
                <div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-border space-y-6 md:col-span-2 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 border-b border-border pb-4">
                <div className="p-2 bg-rose-50 rounded-lg"><Shield className="w-5 h-5 text-rose-600" /></div>
                <h2 className="text-lg font-bold text-foreground">Brand Guardrails</h2>
              </div>
          ...
          <div className="flex items-center justify-end space-x-4 bg-muted p-4 rounded-xl border border-border">
            ...
            <button type="submit" disabled={saveStatus === 'saving' || saveStatus === 'saved'} className="px-6 py-2.5 bg-primary text-white font-semibold rounded-lg shadow-md shadow-indigo-200 hover:bg-primary-hover hover:shadow-lg transition-all disabled:opacity-70 flex items-center gap-2 min-w-[140px] justify-center">
        ...
        <div className="space-y-8">
          {!isConfigured ? (
            <div className="text-center py-20 bg-white border border-border border-dashed rounded-2xl">
              ...
              <h3 className="text-xl font-bold text-foreground mb-2">No Brand Brain Found</h3>
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">Configure your brand identity to ensure all AI-generated content aligns perfectly with your voice, audience, and guardrails.</p>
              <button onClick={handleEdit} className="px-6 py-3 bg-primary text-white font-semibold rounded-lg shadow-md hover:bg-primary-hover transition-all inline-flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-border space-y-6 hover:shadow-md transition-shadow">
                ...
                <div className="grid grid-cols-1 gap-5">
                  <div><span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-1">Brand Name</span><span className="text-foreground font-medium text-lg">{brand.name}</span></div>
                  <div><span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-1">Description</span><span className="text-slate-700 leading-relaxed">{brand.description || '-'}</span></div>
                  <div>
                    <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-2">Products</span>
                    <div className="flex flex-wrap gap-2">
                      {brand.products?.length ? brand.products.map((p: string) => <span key={p} className="bg-muted text-slate-700 text-sm px-3 py-1 rounded-full font-medium">{p}</span>) : '-'}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-border space-y-6 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-5">
                  <div>
                    <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-2">Target Audience</span>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div><span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-1">Tone</span><span className="text-slate-700 font-medium">{brand.tone || '-'}</span></div>
                  <div>
                    <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-2">Approved Messaging</span>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-border space-y-6 md:col-span-2 hover:shadow-md transition-shadow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-2">Prohibited Words</span>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div>
                    <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-2">Prohibited Claims</span>
                    <ul className="space-y-2">
                  ...
                  <div className="md:col-span-2">
                    <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-1">Additional Guidelines</span>
                    <p className="text-slate-700 bg-muted p-4 rounded-xl border border-border leading-relaxed">{brand.guidelines || 'No additional guidelines specified.'}</p>
                  </div>
                </div>
              </div>
            </div>
